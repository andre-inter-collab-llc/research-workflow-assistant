...
@mcp.tool()
async def draft_openalex_search(
    query: str,
    project_path: str,
    filters: str | None = None,
    sort: str = "relevance_score:desc",
    ...
    """Draft a reproducible OpenAlex search script for user review.
    ...
    result = generate_search_script(resolved, "openalex", query, params)
    if result is None:
        return {"error": "Failed to generate OpenAlex search script."}
...
async def run_search_script(
    ...
    Run this after reviewing a script generated by draft_openalex_search.
