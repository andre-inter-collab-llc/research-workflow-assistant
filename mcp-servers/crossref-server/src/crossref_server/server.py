...
@mcp.tool()
async def draft_crossref_search(
    query: str,
    project_path: str,
    filters: str | None = None,
    rows: int = 20,
    ...
    result = generate_search_script(resolved, "crossref", query, params)
    if result is None:
        return {"error": "Failed to generate CrossRef search script."}
...
async def run_search_script(
    ...
    Run this after reviewing a script generated by draft_crossref_search.
