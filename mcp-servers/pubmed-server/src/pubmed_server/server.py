...
async def draft_pubmed_search(
    ...
    result = generate_search_script(resolved, "pubmed", query, params)
    if result is None:
        return {"error": "Failed to generate PubMed search script."}
...
async def run_search_script(
    ...
    Run this after reviewing a script generated by draft_pubmed_search.
